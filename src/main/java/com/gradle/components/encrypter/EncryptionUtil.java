/*
 * Copyright (c) 20/3/18 11:53 AM Bitwise Ventures
...
public class EncryptionUtil
{
    ...
    /**
     *
     * @param input String which we need to encrypt
     * @return Encrypted string with PBEKeySpec encrypt
     */
    ...
    /**
     *
     * @param token which needs to be decrypted
