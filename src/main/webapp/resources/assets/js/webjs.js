...
$(document).ready(function() {
	...
	var fname			= $('.filename');
	var navbar			= $('#navbar-top-header-main');
...
/*/////////////Windows Scrolling /////////////*/
	$(window).on('scroll', function() {
		...
		if (scroll >= 50) {
            ...
            //$("#top-quick-ad-search").css({'margin-top': '78px'});
            $("#top-quick-ad-search").stop().animate({'margin-top': '1px'},500);
		} else {
			//console.log('a');
			header.removeClass("fixed-header");
            //$("#top-quick-ad-search").css({'margin-top': '117px'});
            $("#top-quick-ad-search").stop().animate({'margin-top': '117px'},500);
